  ...
  build: (
    ...
    .ExternalClass div {
      ...
      .btn-primary table td:hover {
        background-color: #238a7d !important;
      }
    
      .btn-primary a:hover {
        background-color: #238a7d !important;
        border-color: #238a7d !important;
      }
    }
    </style>
      </head>
                        ...
                        <tr>
                          <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="btn btn-primary" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; box-sizing: border-box; width: 100%;" width="100%">
                              <tbody>
                                <tr>
                                  <td align="center" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px; text-align: center;" valign="top">
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
                                      <tbody>
                                        <tr>
                                          <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; border-radius: 5px; text-align: center; background-color: #1c6e64;" valign="top" align="center" bgcolor="#1c6e64"> <a href="${buttonLink}" target="_blank" style="border: solid 1px #1c6e64; border-radius: 5px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; text-transform: capitalize; background-color: #1c6e64; border-color: #1c6e64; color: #ffffff;">${buttonLabel}</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
