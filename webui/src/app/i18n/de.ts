const DE = {
    ...
    "settings.backupInterval": "Alle 2 Minuten automatisch speichern (Empfohlen).",
    "settings.backupAutoDisplayMessage": "Bestätigungsnachricht beim automatischen Speichern anzeigen.",
