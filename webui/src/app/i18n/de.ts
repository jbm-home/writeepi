const DE = {
  ...
  "settings.apostropheConf": "Ersetze das gerade Apostroph (') durch das typografische Apostroph (’).",
  "settings.ellipsisConf": "Ersetze drei aufeinanderfolgende Punkte \"...\" durch das einzelne Auslassungszeichen \"…\".",
  ...
  "settings.about": "Über",
  "settings.buymecoffee": "Mögen Sie Writeepi? Unterstützen Sie die Entwicklung auf",
