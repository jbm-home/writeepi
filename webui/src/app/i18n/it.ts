const IT = {
  ...
  "settings.apostropheConf": "Sostituire l'apostrofo dritto (') con l'apostrofo tipografico (’).",
  "settings.ellipsisConf": "Sostituire tre punti consecutivi \"...\" con il carattere unico di puntini di sospensione \"…\".",
