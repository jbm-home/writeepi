const ES = {
  ...
  "settings.apostropheConf": "Reemplazar la apóstrofe recta (') por la apóstrofe tipográfica (’).",
  "settings.ellipsisConf": "Reemplazar tres puntos consecutivos \"...\" por el carácter único de puntos suspensivos \"…\".",
