const ES = {
  ...
  'settings.quoteConf':
    'Reemplaza los dobles "<<" y ">>" por comillas de apertura y cierre.',
  'settings.spaceConf': 'Reemplazar dobles espacios por un punto y un espacio.',
  'settings.apostropheConf':
    "Reemplazar la apóstrofe recta (') por la apóstrofe tipográfica (’).",
  'settings.ellipsisConf':
    'Reemplazar tres puntos consecutivos "..." por el carácter único de puntos suspensivos "…".',
  'settings.backupsettings': 'Configuración de copia de seguridad',
  'settings.backupOnChange':
    'Guardar los cambios en caso de navegación (Recomendado).',
  'settings.backupInterval':
    'Guardar cambios periódicamente cada 2 minutos (Recomendado).',
