const EN = {
  ...
  "settings.apostropheConf": "Replace straight apostrophe (') with typographic apostrophe (’).",
  "settings.ellipsisConf": "Replace three consecutive dots \"...\" with the single ellipsis character \"…\".",
