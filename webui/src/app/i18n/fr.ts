const FR = {
  ...
  "settings.apostropheConf": "Remplacer l'apostrophe droite (') par l’apostrophe typographique (’).",
  "settings.ellipsisConf": "Remplacer trois points consécutifs \"...\" par le caractère unique de points de suspension \"…\".",
